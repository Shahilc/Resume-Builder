...
class _EditDataPageState extends State<EditDataPage> {
  ...
  void initState() {
    ...
    controllerTitle.text=widget.data['University'].toString();
    controllerMessage.text=widget.data['CourseName'].toString();
    super.initState();
  }
  @override
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      const Text('Update Education',style: TextStyle(fontSize: 30,color: Colors.black26),),
                  ...
                  InkWell(
                    onTap: (){
                      ...
                      if(validate) {
                        GlobalList.educationData.removeAt(widget.index);
                        setState(() {
