...
class EditSkills extends StatefulWidget {
  ...
  final int index;
  const EditSkills({super.key, required this.data, required this.index});

  @override
  State<EditSkills> createState() => _EditDataPageState();
}

class _EditDataPageState extends State<EditSkills> {
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      const Text('Update Skill',style: TextStyle(fontSize: 30,color: Colors.black26),),
                  ...
                  InkWell(
                    onTap: (){
                      ...
                      if(validate) {
                        GlobalList.skillData.removeAt(widget.index);
                        setState(() {
